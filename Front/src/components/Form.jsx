        ...
        <div className="row justify-content-center align-items-center vh-100">
          <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6 text-center">
            <img
              ...
              alt="Logo TechStream"
            />
            <h2 className="pt-5">Inicio de sesión</h2>
            <form onSubmit={handleSubmit}>
              ...
              <div className={`form-group ${(passwordError==="Contraseña incorrecta") ? "has-error" : ""}`}>
                <input
                  type="password"
                  name="pass"
                  className={`form-control ${
                    (passwordError==="Contraseña incorrecta") ? "is-invalid" : ""
                  }`}
                  id=""
